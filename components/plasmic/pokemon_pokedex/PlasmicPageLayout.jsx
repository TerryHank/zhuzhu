...
import sty from "./PlasmicPageLayout.module.css"; // plasmic-import: wwnIe0TYNv9v/css
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: rX3aaD-MJ1F5/icon
import Icon2Icon from "./icons/PlasmicIcon__Icon2"; // plasmic-import: 8sRAs2bpDHnj/icon
...
function PlasmicPageLayout__RenderFunc(props) {
  ...
  return (
    <RichLayout
      ...
      logoElement={
        <Icon2Icon
          className={classNames(projectcss.all, sty.svg__hHzOs)}
          role={"img"}
        />
      }
      navMenuItems={(() => {
    ...
    >
      <LoadingBoundary
        ...
        loadingState={
          <DataCtxReader__>
            {$ctx => (
              <div className={classNames(projectcss.all, sty.freeBox__dd495)}>
                <IconIcon
                  className={classNames(projectcss.all, sty.svg__vcgX1)}
                  role={"img"}
                />
              </div>
            )}
      ...
      >
        <DataCtxReader__>
          {$ctx => (
            <div className={classNames(projectcss.all, sty.freeBox__tqqAw)}>
              {renderPlasmicSlot({
                defaultContents: (
                  <section
                    className={classNames(projectcss.all, sty.section__zOBtr)}
                  >
                    <h1
                      className={classNames(
                        projectcss.all,
